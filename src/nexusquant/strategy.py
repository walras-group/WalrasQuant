...
from nexusquant.indicator import IndicatorManager, Indicator, IndicatorProxy
from nexusquant.core.entity import TaskManager, is_redis_available
from nexusquant.core.cache import AsyncCache
from nexusquant.error import StrategyBuildError
...
from nexusquant.core.connection import ConnectionPolicyState
from nexusquant.push import FlashDutyPushService, EventStatus
from nexusquant.execution import (
    ExecAlgorithm,
...
class Strategy:
    ...
    def register(
        ...
        if strategy_id and user_id and is_redis_available() and enable_cli:
            try:
                from nexusquant.cli.monitor.state_exporter import StrategyStateExporter

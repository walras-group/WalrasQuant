...
from nexusquant.constants import ExchangeType
from nexusquant.exchange.base_factory import ExchangeFactory
...
class ExchangeRegistry:
    ...
    def discover_factories(self) -> None:
        ...
        This method scans the nexusquant.exchange package for factory modules
        ...
        try:
            import nexusquant.exchange as exchange_package
            ...
            for importer, modname, ispkg in pkgutil.iter_modules(package_path):
                ...
                try:
                    ...
                    factory_module_name = f"nexusquant.exchange.{modname}.factory"

...
from nexusquant.cli.app import run_monitor
...
def status():
    ...
    try:
        ...
        running_strategies = redis_client.hgetall("nexusquant:running_strategies")
...
def main():
    """Main entry point for nexusquant-cli command"""
    cli()

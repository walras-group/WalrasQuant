...
from nexusquant.config import Config, WebConfig
from nexusquant.strategy import Strategy
...
from nexusquant.exchange.registry import get_factory
from nexusquant.exchange.base_factory import BuildContext

from nexusquant.core.entity import TaskManager, ZeroMQSignalRecv
from nexusquant.core.nautilius_core import setup_nexus_core
from nexusquant.schema import InstrumentId
from nexusquant.web.app import StrategyFastAPI
from nexusquant.web.server import StrategyWebServer
from nexusquant.base.ws_client import WSClient
from nexusquant.core.connection import (
    ConnectionState,
    ConnectionPolicyState,
    ConnectionRole,
)
from nexusquant.push import FlashDutyPushService
from nexusquant.execution.algorithm import ExecAlgorithm
from nexusquant.core.entity import OidGen
...
class Engine:
    ...
    def add_exec_algorithm(self, algorithm: ExecAlgorithm):
        ...
        Example
        -------
        >>> from nexusquant.execution import TWAPExecAlgorithm
